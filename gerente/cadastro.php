    ...
    <form action="acao.php" method="post">
        ...
        <div class="row mt-2">
            <div class="col-5">
                ...
                <input type="text" name="nome" id="nome" class="form-control border-success text-center" value="<?php if($id != 0) echo $gerente["nome"];?>" required>
            </div>
            <div class="col-2 ms-4">
                <label for="dataNasc" class="form-label">Data de Nascimento:</label>
            <input type="date" name="dataNasc" id="dataNasc" class="form-control border-success" value="<?php if($id != 0) echo $gerente["dataNasc"]?>" required>
            </div>
        ...
        <div class="row mt-3">
                <div class="col-3">
                    ...
                    <input type="text" name="cpf" id="cpf" class="form-control border-success text-center" placeholder="000.000.000-00" value="<?php if($id != 0) echo $gerente["cpf"]?>" required>
                </div>  
                <div class="col-3">
                    <label for="celular" class="form-label">Celular:</label>
                    <input type="text" name="celular" id="celular" class="form-control border-success text-center" placeholder="(00) 00000-0000" value="<?php if($id != 0) echo $gerente["celular"]?>" required>
                </div>
                <div class="col-6">
                    <label for="email" class="form-label">E-mail:</label>
                    <input type="text" name="email" id="email" class="form-control border-success text-center" placeholder="dominio@email.com" value="<?php if($id != 0) echo $gerente["email"]?>" required>    
                </div>               
            </div>
            ...
            <div class="row mt-3">
                <div class="col-3">
                    ...
                    <input type="text" name="cep" id="cep" class="form-control border-success text-center" placeholder="00000-0000" value="<?php if($id != 0) echo $gerente["cep"]?>" required>
                </div> 
                <div class="col-3">
                ...
                <div class="col-3">
                    ...
                    <input type="text" name="cidade" id="cidade" class="form-control border-success text-center" value="<?php if($id != 0) echo $gerente["cidade"]?>" required> 
                </div>
                <div class="col-3">
                    <label for="bairro" class="form-label">Bairro:</label>
                    <input type="text" name="bairro" id="bairro" class="form-control border-success text-center" value="<?php if($id != 0) echo $gerente["bairro"]?>" required> 
                </div>                     
            </div>
            ...
            <div class="row mt-3">
                <div class="col-3">
                    ...
                    <input type="text" name="rua" id="rua" class="form-control border-success text-center" value="<?php if($id != 0) echo $gerente["rua"]?>" required>
                </div> 
                <div class="col-7">
            ...
            <div class="row mt-3">
                <div class="col-3">
                    ...
                    <input type="text" name="usuario" id="usuario" class="form-control border-success text-center" value="<?php if($id != 0) echo $gerente["usuario"];?>" required>
                </div>
                <div class="col-3">
                    <label for="matricula" class="form-label">Matrícula:</label>
                    <input type="text" name="matricula" id="matricula" class="form-control border-success text-center" value="<?php if($id != 0) echo $gerente["matricula"]?>" required>
                </div>
                <div class="col-3">
                    <label for="senha" class="form-label">Criar Senha:</label>
                    <input type="password" name="senha" id="senha" class="form-control border-success text-center" value="<?php if($id != 0) echo $gerente["senha"]?>" required>
                </div>
                <div class="col-3">
